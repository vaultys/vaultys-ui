...
var Table = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "vui-bg-light-secondary dark:vui-bg-dark-secondary vui-p-4 vui-rounded-large vui-shadow-small vui-flex vui-flex-col vui-relative vui-min-h-[400px] ", children: [
...
var Loader = ({ message, img }) => {
  ...
  if (show) {
    return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "py-7 h-screen flex flex-row items-center bg-primary", children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "flex flex-col items-center m-auto gap-5 p-10 backdrop-blur rounded-full shadow-[rgba(0,_0,_0,_0.2)_0px_30px_20px_-7px] bg-white bg-opacity-25", children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("img", { src: img, className: "h-56", alt: "Smartlink" }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "", children: message })
    ] }) });
  } else
