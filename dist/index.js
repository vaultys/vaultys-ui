...
var SelectLanguage = ({ languages, onLanguageClicked, currentValue }) => {
  const Flag = ({ lc, emoji }) => /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: `text-3xl cursor-pointer px-1 ${currentValue == lc ? "" : "opacity-20"}`, onClick: () => onLanguageClicked(lc), "data-test": lc, children: emoji });
