...
export const InputPassword = ({ label, description, onChange, valid = true, color, placeholder, value, disabled, copyToClipboard = false, testId, }) => {
    ...
    return (_jsx(Input, { autoComplete: "off", "data-testid": testId, label: label, value: value, placeholder: placeholder, onValueChange: (value) => onChange && onChange(value), classNames: {
            inputWrapper: color,
