...
export const PasswordGenerator = ({ passwordType, passwordConfig, passphraseConfig, locale = "fr", onConfigChanged }) => {
    ...
    return (_jsxs("div", { className: "flex flex-col gap-4 w-full p-4 rounded-lg bg-background shadow-xs", children: [_jsx(Switch, { isSelected: type === PasswordType.PASSWORD, onValueChange: () => setType(type === PasswordType.PASSWORD ? PasswordType.PASSPHRASE : PasswordType.PASSWORD), "data-testid": "password-generator-select-type-switch", children: _jsxs("div", { className: "flex flex-row gap-2 items-center", children: [type === PasswordType.PASSWORD ? _jsx(RiLockPasswordFill, {}) : _jsx(BiKey, {}), type === PasswordType.PASSWORD ? TRAD.password[locale] : TRAD.passphrase[locale]] }) }), _jsx("div", { className: "relative", children: _jsx(Tooltip, { content: TRAD.clickToCopy[locale], children: _jsxs("div", { className: `cursor-pointer flex flex-row justify-between items-center gap-4 p-4 border rounded-lg transition-colors ${copied ? "border-success bg-success bg-opacity-10" : "border-default-200 hover:bg-default-100"}`, "data-testid": "password-generator-password-area", onClick: () => {
                            navigator.clipboard.writeText(type === PasswordType.PASSWORD ? password : passphrase);
                            setCopied(true);
                            setTimeout(() => setCopied(false), 1500);
                        }, children: [_jsx("div", { className: "font-mono text-lg break-all", children: type === PasswordType.PASSWORD ? password : passphrase }), _jsx("div", { className: "shrink-0 flex items-center gap-1 text-sm", children: copied ? (_jsxs("span", { className: "flex items-center gap-1 text-success", children: [TRAD.copied[locale], " ", _jsx(BiCheck, { size: 18 })] })) : (_jsx(BiCopy, { size: 18, className: "text-default-500" })) })] }) }) }), _jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex justify-between items-center text-sm", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: "font-medium", children: TRAD.passwordStrength[locale] }), _jsx(Tooltip, { content: TRAD.infoTooltip[locale], children: _jsx(Button, { isIconOnly: true, size: "sm", variant: "light", children: _jsx(BsInfoCircleFill, { className: "text-default-400" }) }) })] }), _jsx(Chip, { size: "sm", color: getStrengthInfo().color, variant: "flat", children: getStrengthInfo().label })] }), _jsx(Progress, { size: "md", "aria-label": "Password strength", classNames: {
                            indicator: `${entropy <= 35 ? "bg-danger" : ""} ${entropy > 35 && entropy <= 59 ? "bg-warning" : ""} ${entropy > 59 && entropy < 120 ? "bg-success" : ""} ${entropy >= 120 ? "bg-primary" : ""}`,
                        }, value: entropy, maxValue: 120, minValue: 0, showValueLabel: false })] }), _jsxs("div", { className: "border border-default-200 rounded-lg p-4 bg-default-50", "data-testid": "password-generator-password-options", children: [_jsx("h4", { className: "text-sm font-medium mb-3", children: TRAD.options[locale] }), type === PasswordType.PASSWORD ? (_jsxs("div", { className: "flex flex-col gap-4", children: [_jsx(Slider, { "data-testid": "password-generator-password-length", label: `${TRAD.charNumber[locale]} (${length})`, minValue: 8, maxValue: 128, value: length, onChange: (value) => setLength(value), onChangeEnd: generatePassword, size: "sm", classNames: {
                                    filler: "bg-primary",
                                } }), _jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2 mt-2", children: [_jsx(Checkbox, { color: "primary", isSelected: lowercaseLetters, onValueChange: (value) => setLowercaseLetters(value), "data-testid": "password-generator-password-lowercase", children: "a-z" }), _jsx(Checkbox, { color: "primary", isSelected: capitalLetters, onValueChange: (value) => setCapitalLetters(value), "data-testid": "password-generator-password-uppercase", children: "A-Z" }), _jsx(Checkbox, { color: "primary", isSelected: numbers, onValueChange: (value) => setNumbers(value), "data-testid": "password-generator-password-numbers", children: "0-9" }), _jsx(Checkbox, { color: "primary", isSelected: specialCharacters, onValueChange: (value) => setSpecialCharacters(value), "data-testid": "password-generator-password-symbols", children: SPECIAL_CHARS })] })] })) : (_jsxs("div", { className: "flex flex-col gap-4", children: [_jsx(Slider, { "data-testid": "password-generator-passphrase-length", label: `${TRAD.wordNumber[locale]} (${wordsNumber})`, minValue: 4, maxValue: 24, value: wordsNumber, onChange: (value) => setWordsNumber(value), onChangeEnd: generatePassphrase, size: "sm", classNames: {
                                    filler: "bg-primary",
                                } }), _jsxs(Select, { label: TRAD.language[locale], selectedKeys: [language], size: "sm", className: "max-w-xs", "data-testid": "password-generator-passphrase-language", children: [_jsx(SelectItem, { onPress: () => setLanguage("fr"), children: TRAD.french[locale] }, "fr"), _jsx(SelectItem, { onPress: () => setLanguage("en"), children: TRAD.english[locale] }, "en")] })] }))] }), _jsx("div", { className: "flex justify-end mt-2", children: _jsx(Button, { startContent: _jsx(FiRefreshCcw, {}), onPress: () => (type === PasswordType.PASSWORD ? generatePassword() : generatePassphrase()), color: "primary", size: "sm", "data-testid": "password-generator-regenerate-button", children: TRAD.regenerate[locale] }) })] }));
};
