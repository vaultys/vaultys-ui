    ...
    const getChild = () => {
        switch (type) {
            case ColumnType.BUTTON:
                return _jsx(RowItemButton, { onClick: () => typeof onClick === "function" && onClick(), title: title ?? "", disabled: disabled });
            ...
            case ColumnType.EDIT_TEXT:
                return (_jsx(RowItemEditText, { inputType: inputType, maxLines: maxLines, onClick: () => typeof onClick === "function" && onClick(), editMode: editMode ?? false, onChange: (value) => typeof onChange === "function" && onChange(value), value: value }));
            ...
            case ColumnType.TEXT:
                return _jsx(RowItemSpan, { value: value ?? title });
            case ColumnType.DROPDOWN:
                return _jsx(RowItemDropdown, { value: value, items: items ?? [], onChange: (value) => onChange && onChange(value) });
            default:
