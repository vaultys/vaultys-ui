...
export function SecureInfoForm() {
    ...
    return (_jsxs("div", { className: "max-w-md mx-auto mt-8 p-6 dark:bg-dark rounded-lg shadow-lg", children: [_jsxs("div", { className: "flex items-center justify-center mb-6", children: [_jsx(BsLock, { className: "text-3xl text-primary mr-2" }), _jsx("h2", { className: "text-2xl font-semibold dark:text-light", children: "Secure Information Vault" })] }), _jsxs("form", { className: "space-y-4", onSubmit: (e) => e.preventDefault(), children: [_jsx(Input, { type: "text", label: "Application Name", id: "appName", name: "appName", isRequired: true }), _jsx(Input, { type: "text", label: "Username", id: "username", name: "username", isRequired: true }), _jsx(Input, { type: "password", label: "Password", id: "password", name: "password", isRequired: true }), customFields.map(renderCustomField), _jsx(Select, { label: "Add Field", placeholder: "Select field type", onChange: (e) => addCustomField(e.target.value), children: fieldTypes.map((type) => (_jsx(SelectItem, { value: type.value, children: type.label }, type.value))) }), _jsx(Checkbox, { children: "Remember this device" }), _jsx(Button, { color: "primary", type: "submit", className: "w-full", children: "Save Securely" })] }), _jsx("span", { className: "mt-4 text-xs text-gray-500 text-center", children: "Your information is encrypted and securely stored. We never share your data." }), _jsx(Modal, { className: "dark:text-white", backdrop: "blur", placement: "center", isOpen: !!showConfirmation, onClose: () => setShowConfirmation(null), children: _jsxs(ModalContent, { children: [_jsx(ModalHeader, { children: _jsx("h3", { children: "Confirm Deletion" }) }), _jsx(ModalBody, { children: _jsx("span", { children: "This field contains a value. Are you sure you want to remove it? This action cannot be undone." }) }), _jsxs(ModalFooter, { children: [_jsx(Button, { color: "danger", onPress: confirmRemoveField, children: "Yes, Remove Field" }), _jsx(Button, { color: "default", onPress: () => setShowConfirmation(null), children: "Cancel" })] })] }) })] }));
}
