"use client";
export const WindowScreen = ({ children, icon, title = "SmartLink", size = "lg" }) => (<div className="flex flex-col w-full p-2 h-screen justify-center items-center bg-light bg-opacity-50 backdrop-blur">
    <div className={`max-h-full  shadow-lg w-full shadow-black/40 rounded-t-xl rounded-b overflow-clip ${size === "sm" && "max-w-xl"} ${size === "md" && "max-w-3xl"} ${size === "lg" && "max-w-5xl"} ${size === "xl" && "max-w-7xl"}`}>
